...
function App() {
  ...
  const renderHome = () => (
    <div className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden px-4">
       ...
       <div className="z-10 text-center animate-[fadeIn_1s_ease-out] relative">
         <p className="text-sm md:text-base tracking-[0.3em] uppercase mb-6 text-stone-200 font-medium bg-black/30 inline-block px-4 py-1 backdrop-blur-sm rounded-full">{ROLE_TITLE}</p>
         <h1 className="text-5xl md:text-8xl font-serif text-white leading-tight mb-8 drop-shadow-2xl">
           {SITE_TITLE.split(' ')[0]} <br className="md:hidden" />
           <span className="italic font-light">{SITE_TITLE.split(' ')[1]}</span>
         </h1>
         <p className="max-w-md mx-auto text-stone-100 font-medium leading-relaxed mb-12 drop-shadow-lg bg-black/30 backdrop-blur-md p-4 rounded-xl">
            Piano performance uniting classical technique with deep emotion.
         </p>
         <button 
           onClick={() => handleViewChange(ViewState.PORTFOLIO)}
           className="border-2 border-white px-8 py-3 text-sm tracking-widest uppercase text-white hover:bg-white hover:text-stone-900 transition-all duration-300 bg-black/20 backdrop-blur-md shadow-xl"
         >
           View Career
         </button>
       </div>

       <div className="absolute bottom-12 animate-bounce cursor-pointer z-10" onClick={() => handleViewChange(ViewState.PORTFOLIO)}>
         <ArrowDown className="text-white/80 font-thin" size={32} />
       </div>
    </div>
  );
  ...
  const renderPortfolio = () => (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-20 px-6 container mx-auto page-transition">
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-5xl font-serif italic mb-4 text-white drop-shadow-lg">Repertoire & Events</h2>
  ...
  const renderAbout = () => (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-24 pb-20 px-6 container mx-auto flex items-center page-transition">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-[16/9] md:aspect-[4/3] bg-stone-200 overflow-hidden shadow-2xl rotate-1 rounded-sm border-8 border-white">
            <img 
          ...
          <div>
            <h2 className="text-4xl md:text-6xl font-serif mb-8 leading-tight text-white drop-shadow-2xl">
              Passion for <br/> <span className="italic text-stone-300">Piano</span>
            </h2>
            <div className="space-y-6 text-stone-200 font-light leading-loose text-lg text-justify">
               {ABOUT_TEXT.split('\n').map((paragraph, idx) => (
            ...
            <div className="mt-12">
               <div className="flex items-center gap-4 opacity-80">
                  ...
                  <span className="font-serif italic text-xl text-white">Adriana B.</span>
               </div>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-20 px-6 container mx-auto page-transition">
        <div className="mb-16 text-center">
          <h2 className="text-4xl md:text-6xl font-serif italic mb-4 text-white drop-shadow-lg">Research & Publications</h2>
          <div className="w-12 h-[1px] bg-stone-400 mx-auto"></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-3xl md:text-4xl font-serif text-white">Books</h3>
              </div>
              <h4 className="text-2xl font-serif italic text-stone-200 mb-4">Una Lengua, una forma de Ver el Mundo</h4>
              <p className="text-sm text-stone-400 mb-6">(One Language, one Way to See the World)</p>
              ...
              <div className="space-y-4 text-stone-200 leading-relaxed">
                ...
                <p className="text-stone-400 italic">English version coming soon.</p>
              </div>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 mt-8 border-2 border-white px-6 py-3 text-sm tracking-widest uppercase text-white hover:bg-white hover:text-stone-900 transition-all duration-300"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-3xl md:text-4xl font-serif text-white">Translations</h3>
                </div>
                <h4 className="text-2xl font-serif italic text-stone-200 mb-2">Le Langage Musical</h4>
                <p className="text-lg text-stone-300 mb-6">by André Boucourechliev</p>
                <p className="text-sm text-stone-400 mb-6">Translated into Spanish by Adriana Biaggi</p>
  ...
  const renderContact = () => (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-20 px-6 container mx-auto flex flex-col justify-center page-transition">
         <div className="max-w-4xl mx-auto text-center">
           <h2 className="text-4xl md:text-6xl font-serif mb-12 text-white drop-shadow-2xl">Contact</h2>
           <p className="text-xl font-light text-stone-200 mb-12">
             For recitals, masterclasses, or musical collaborations, please write to me.
           </p>
           
           <a href={`mailto:${CONTACT_EMAIL}`} className="text-2xl md:text-4xl font-serif italic underline decoration-1 underline-offset-8 hover:text-stone-300 transition-colors text-white drop-shadow-lg">
             {CONTACT_EMAIL}
           </a>

           <div className="mt-24 flex justify-center gap-12">
             <a href={SOCIAL_LINKS.find(l => l.platform === 'Instagram')?.url || '#'} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-4 group">
               <div className="w-16 h-16 border-2 border-stone-400 rounded-full flex items-center justify-center group-hover:border-white group-hover:bg-white/10 transition-all duration-300">
                 <Instagram className="text-stone-300 group-hover:text-white transition-colors" />
               </div>
             ...
             <a href="#" className="flex flex-col items-center gap-4 group">
               <div className="w-16 h-16 border-2 border-stone-400 rounded-full flex items-center justify-center group-hover:border-white group-hover:bg-white/10 transition-all duration-300">
                 <Linkedin className="text-stone-300 group-hover:text-white transition-colors" />
               </div>
             ...
             {SOCIAL_LINKS.find(l => l.platform === 'YouTube') && (
               <a href={SOCIAL_LINKS.find(l => l.platform === 'YouTube')?.url} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-4 group">
                 <div className="w-16 h-16 border-2 border-stone-400 rounded-full flex items-center justify-center group-hover:border-white group-hover:bg-white/10 transition-all duration-300">
                   <Youtube className="text-stone-300 group-hover:text-white transition-colors" />
                 </div>
